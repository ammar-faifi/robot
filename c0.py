    ...
    while running:
        for event in pygame.event.get():
            ...
            if event.type == pygame.JOYBUTTONDOWN or event.type == pygame.JOYHATMOTION:
                ...
                for button, motor in motor_commands.items():
                    if joystick.get_button(0 if button == "x" else 
                                           1 if button == "circle" else
                                           2 if button == "square" else
                                           3 if button == "triangle" else
                                           4 if button == "l1" else
                                           5 if button == "r1" else
                                           7): # if button == "r2"
                            ...
                            #     send_command("M7C")
                                # print("M7C")
                            if joystick.get_hat(0) == (1, 0) or joystick.get_axis(0) > 0.5:  # Right
                                if motor == "M7":
                                    send_command("M7C");
                                else:
                                    send_command(f"{motor}CW")
                                # print(f"{motor}CW")
                            elif joystick.get_hat(0) == (-1, 0) or joystick.get_axis(0) < -0.5:  # Left
                                if motor == "M7":
                                    send_command("M7O");
                                else:
            ...
            if event.type == pygame.JOYBUTTONUP:
                ...
                for button, _ in motor_commands.items():
                    if event.button == (0 if button == "x" else 
                                        1 if button == "circle" else
                                        2 if button == "square" else
                                        3 if button == "triangle" else
                                        4 if button == "l1" else
                        ...
                        send_command("M7S")
                        for i in range(1, 7):
                            send_command(f"M{i}STOP")  # Assumes Arduino code can handle "MxSTOP" to stop motors
